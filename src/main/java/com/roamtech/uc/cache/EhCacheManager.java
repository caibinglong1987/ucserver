...
import com.roamtech.uc.util.ConfigurationException;
import com.roamtech.uc.util.ResourceUtils;
...
public class EhCacheManager /*implements CacheManager*/ {
    ...
    private static final int MAX_ELEMENTS_IN_MEMORY = 100000;
    /**
     ...
     */
    private String cacheManagerConfigFile = "classpath:com/roamtech/uc/cache/ehcache.xml";
    ...
    public final <K, V> Cache<K, V> getCache(String name) throws CacheException {
        ...
        try {
            ...
            if (cache == null) {
                ...
                net.sf.ehcache.Cache cacheImpl = new net.sf.ehcache.Cache( name, MAX_ELEMENTS_IN_MEMORY, false,
                        false, 3600, 3600); 
                this.manager.addCache(cacheImpl);
