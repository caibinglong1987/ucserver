...
public class VoiceGetService extends AbstractService {
	...
	public void doHandle(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response)
		...
		if(tvReq.validate()) {
			if(ucService.isSessionValid(tvReq.getSessionId())) {
				rdo = ucService.getCurrentAvailableVoice(tvReq.getUserid());
			} else {
		...
		if(rdo != null) {
			...
			ucResp.addAttribute("voicenumber", rdo.getVoiceNumber());	
		}
